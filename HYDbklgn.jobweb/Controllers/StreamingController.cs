...
namespace HYDbklgn.jobweb.Controllers
{
    ...
    public class StreamingController : ApiController
    {
        ...
        public StreamingController(HYDbklgnEntities itdb, IMiscLog mlog, IStdbLog dlog, IErrorLog elog)
        {
            db = itdb;
            miscLog = mlog;
            errorLog = elog;
        ...
        {
            var browsepath = WK.browsepath.GetAppKeyValue();
            ...
            var baspath = WK.sharepath.GetAppKeyValue();
            if (item != null)
            {
